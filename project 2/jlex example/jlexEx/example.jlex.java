...
class Yylex implements java_cup.runtime.Scanner {
	...
	private final int SPECIALINTSTATE = 1;
...
"4:9,10,11,4:2,0,4:18,10,4:10,7,4:4,1,2:9,4:2,9,6,4:3,5:26,4:3,8,5,4,5:23,3," +
"5:2,4:5,12:2")[0];

	private int yy_rmap[] = unpackFromString(1,22,
"0,1,2,3,1:2,4,1,5,1:3,6,7:2,8,6,1,9,4,5,8")[0];

	private int yy_nxt[][] = unpackFromString(10,13,
"-1,1,2,3,4,3,5,6,7,8,15:2,9,-1:14,2:2,-1:11,3:3,-1,3,-1:13,10,-1:12,11,-1:7" +
",12:2,-1:11,14:2,-1:20,15:2,-1:2,16,12,13,17:3,19,17,20,21,15,9");
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -2:
						break;
					case 1:
						{ yybegin(SPECIALINTSTATE);
                              System.out.println("Entering special state");
                            }
					case -3:
						break;
					case 2:
						{ System.out.println(yyline+1 + ": INTLIT (" 
                                                 + yytext() + ")"); }
					case -4:
						break;
					case 3:
